...
const UpdateTheaterPopUp = (props) => {
  ...
  const updateTheater = () => {
    let requestBody = theater;

    axios.put(`http://localhost:8700/theater/${id}`, requestBody);
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Footer>
          <Button variant="success" onClick={updateTheater}>
            Update Theater
          </Button>
...
export default UpdateTheaterPopUp;
